...
const Nav = () => {
  ...
  `);
  return (<div
      className="z-20 w-screen sm:fixed border-b-2 border-primaryColor-default
       bg-backgroundColor"
    >
      <div className="pt-6 px-4 sm:px-6 lg:px-8">
        <nav
          className="relative flex items-center justify-between
          sm:h-10 lg:justify-start"
          aria-label="Global"
        >
          <div
          ...
          >
            <div
              ...
              <a href={`tel:${data.contentfulGlobal.phone}`}
                 className="md:hidden text-primaryColor-default"
              >
                {data.contentfulGlobal.phone}
              </a>
          ...
          <div className="hidden md:flex justify-between w-full">
            ...
            <a
              href={`tel:${data.contentfulGlobal.phone}`}
              className="hidden md:block text-primaryColor-default"
            >
              {data.contentfulGlobal.phone}
            </a>
          </div>
...
const hamburgerBtn = (toggleMenuCollapsed) => {
  return (
    <div className="-mr-2 flex items-center md:hidden">
      <button
        type="button"
        className="bg-pseudoWhite rounded-md p-2 inline-flex items-center
